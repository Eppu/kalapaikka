<template>
  <div
    id="sticky-banner"
    tabindex="-1"
    class="fixed start-0 top-0 z-50 flex w-full justify-between border-b border-gray-200 bg-gray-50 p-2 dark:border-gray-600 dark:bg-gray-700"
  >
    ...
    <div class="flex items-center">
      ...
      >
        ...
        <span class="sr-only">Sulje banneri</span>
      </button>
    </div>
  </div>
</template>
